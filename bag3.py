...
def transfer_employees_to_backup(employees):
    ...
    for employee in employees:
        if employee.years_worked >= 10:
            ...
            print(f"Дархан серверлүү {employee.name}-ийн мэдээлийг шилжүүлж байна...")
...
def main():
    ...
    print("УБ Үндсэн сервер дээр байгаа ажилчид:")
    print("+----------------+------------+")
    ...
    print("\nДархан Нөөц серверт байгаа ажилчид (10+ жил ажилласан):")
    print("+----------------+------------+")
    print("|     Нэр        |   Ажилласан Жил|")
    print("+----------------+------------+")
    ...
    print("\nҮндсэн сервер дээр үлдсэн ажилчид:")
    print("+----------------+------------+")
    print("|     Нэр        |   Ажилласан Жил|")
    print("+----------------+------------+")
